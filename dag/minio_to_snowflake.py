...
SNOWFLAKE_USER = "RICHAADESAI"
SNOWFLAKE_PASSWORD = "Richa@12345678"
SNOWFLAKE_ACCOUNT = "AFB19542.us-west-2"
...
def load_to_snowflake(**kwargs):
    ...
    #to run a sql code inside python
    cur.execute("""
...
with DAG(
    ...
    #defining the flow of the process
    task1 >> task2
